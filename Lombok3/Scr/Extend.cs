...
namespace Til.Lombok {
    ...
    public static class StringExtend {
        ...
        public static string format(this string format, Dictionary<string, string> fillMap) {
            StringBuilder stringBuilder = new StringBuilder();
            format.format(stringBuilder,
                k => {
                    string[] ks = k.Split(':');
                    ...
                    stringBuilder.Append(value.formatSingle(f));
                });
            return stringBuilder.ToString();
        }
        
        public static string formatSingle(this string s, string format) {
            switch (format) {
